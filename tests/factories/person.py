...
class ContinuingEducationPersonFactory(factory.DjangoModelFactory):
   ...
   # Identification
    ...
    professional_status = factory.fuzzy.FuzzyChoice(_get_random_choices(STATUS_CHOICES))

    current_occupation = factory.Faker('text', max_nb_chars=50)
    current_employer = factory.Faker('company')

    activity_sector = factory.fuzzy.FuzzyChoice(_get_random_choices(SECTOR_CHOICES))
