...
def RegistrationDictFactory(person_information, state=ACCEPTED, formation=None):
    registration = {
        ...
        'company_number': factory.Faker('isbn10'),
        'vat_number': factory.Faker('ssn'),
        'national_registry_number': factory.fuzzy.FuzzyText(length=12, chars=string.digits),
        'id_card_number': factory.fuzzy.FuzzyText(length=12, chars=string.digits),
        'passport_number': factory.fuzzy.FuzzyText(length=12, chars=string.digits),
